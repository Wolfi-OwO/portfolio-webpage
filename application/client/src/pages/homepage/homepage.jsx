        ...
        <section className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-6 sm:p-9">
          <div className="flex items-start gap-5 sm:gap-6">
            <img
              ...
              fetchPriority="high"
              className="h-40 w-25 shrink-0 rounded-xl border border-[var(--line)] object-cover sm:h-30 sm:w-25"
            />
          ...
          <div className="mt-7 pt-4 flex flex-wrap items-center gap-3 border-t border-[var(--line)]">
            <SocialRow />
          </div>
        </section>
