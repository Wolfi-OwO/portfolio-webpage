...
export default function ErrorPage() {
        ...
        if (error.status === 404)
            return (
                <div className="h-screen w-screen flex flex-col items-center justify-center text-center px-6">
                    ...
                    <h1 className="mt-4 text-7xl font-semibold tracking-tight text-balance">
                        Page not found
                    </h1>
                    <p className="mt-6 text-xl font-medium leading-8 text-pretty text-gray-400">
    ...
    return (
        <div className="h-screen w-screen flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="mt-6 text-xl font-medium leading-8 text-pretty text-gray-400">An unexpected error occoured.</p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
                <NavLink
                    to={'/'}
                    className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
