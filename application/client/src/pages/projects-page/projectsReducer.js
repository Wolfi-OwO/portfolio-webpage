const TECH_COLOR_PRESETS = [
    {
        label: 'Slate',
        value: 'bg-slate-100 text-slate-800 dark:bg-slate-500/20 dark:text-slate-300',
    },
    ...
    {
        label: 'Indigo',
        value: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300',
    },
    {
        label: 'Purple',
        value: 'bg-purple-100 text-purple-800 dark:bg-purple-500/20 dark:text-purple-300',
    },
    ...
    {
        label: 'Orange',
        value: 'bg-orange-100 text-orange-800 dark:bg-orange-500/20 dark:text-orange-300',
    },
    {
        label: 'Yellow',
        value: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-500/20 dark:text-yellow-300',
    },
    {
        label: 'Green',
        value: 'bg-green-100 text-green-800 dark:bg-green-500/20 dark:text-green-300',
    },
    {
        label: 'Emerald',
        value: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-500/20 dark:text-emerald-300',
    },
    { label: 'Cyan', value: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-500/20 dark:text-cyan-300' },
    {
        label: 'Neutral',
        value: 'bg-neutral-200 text-neutral-800 dark:bg-neutral-700/30 dark:text-neutral-200',
    },
];
    ...
    switch (action.type) {
        ...
        case 'ADD_SELECTED_TECH':
            ...
            return {
                ...
                form: {
                    ...state.form,
                    selectedTechnologies: [...state.form.selectedTechnologies, action.payload],
                    techQuery: '',
                },
            };
